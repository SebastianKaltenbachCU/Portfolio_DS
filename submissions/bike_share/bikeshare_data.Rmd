---
title: "Bikeshare Data in Washington D.C. - Data Analysis"
author: "Team 2 - Bikeshare Data"
...
download.file(url, destfile = here("submissions", "bike_share","data","capitalshare.csv.zip"), mode = "wb")
unzip(here("submissions", "bike_share","data", "capitalshare.csv.zip"), exdir = here("submissions", "bike_share","data"))
```

Read in the capitalshare data.

```{r, message=FALSE}
capitalshare <- read_csv(here("submissions", "bike_share","data", "202109-capitalbikeshare-tripdata.csv"), show_col_types = FALSE)
...
```{r, message=FALSE}
neigh = st_read(here("submissions", "bike_share","data", "dc_neigh.geojson")) %>% 
  clean_names() %>%
