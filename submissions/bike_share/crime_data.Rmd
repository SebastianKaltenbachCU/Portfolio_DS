...
```{r, include = FALSE}
crime <- st_read(
  here("submissions","bike_share","data","Crime_Incidents_in_2021.geojson")) %>% clean_names()

neigh = st_read(
  here("submissions","bike_share","data","dc_neigh.geojson")) %>% clean_names()
```
